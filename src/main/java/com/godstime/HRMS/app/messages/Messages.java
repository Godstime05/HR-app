package com.godstime.HRMS.app.messages;

public class Messages {

    public static String NationalityIdIncorrect ="National id is incorrect!";
    public static String BirthYearIncorrect ="Birth year is not valid!";
    public static String NameCanNotBeNull ="User Valid!Name can not be null!";
